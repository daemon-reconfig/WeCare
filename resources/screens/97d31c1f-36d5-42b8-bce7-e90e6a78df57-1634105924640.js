jQuery("#simulation")
  .on("click", ".s-97d31c1f-36d5-42b8-bce7-e90e6a78df57 .click", function(event, data) {
  ...
  .on("pageload", ".s-97d31c1f-36d5-42b8-bce7-e90e6a78df57 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("pageunload", ".s-97d31c1f-36d5-42b8-bce7-e90e6a78df57 .pageunload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
