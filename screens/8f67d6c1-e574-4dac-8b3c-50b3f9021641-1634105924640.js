jQuery("#simulation")
  .on("click", ".s-8f67d6c1-e574-4dac-8b3c-50b3f9021641 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-8f67d6c1-e574-4dac-8b3c-50b3f9021641 #s-Paragraph_6 span" ],
                    "attributes": {
                      "color": "#EEC0BC"
                    }
                  } ],
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-8f67d6c1-e574-4dac-8b3c-50b3f9021641 #s-Button_1" ],
                    "attributes": {
                      "filter": "drop-shadow(-3.061616997868383E-16px 5.0px 7.5px #999999)",
                      "text-shadow": "none"
                    }
                  },{
                    "target": [ "#s-8f67d6c1-e574-4dac-8b3c-50b3f9021641 #s-Button_1 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
